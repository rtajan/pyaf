#ifndef MULTIPLIER_SINE_CCC_HPP
#define MULTIPLIER_SINE_CCC_HPP
...
class Multiplier_sine_ccc : public Multiplier<R>
{
private:
...
public:
	Multiplier_sine_ccc (const int N, const R f, const R Fs = 1.0f, const int n_frames = 1);
	void reset();
	void set_f (R f);
