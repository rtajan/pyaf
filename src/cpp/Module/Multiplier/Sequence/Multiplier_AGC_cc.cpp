...
template <typename R>
Multiplier_AGC_cc<R>
::Multiplier_AGC_cc(const int N, const R output_energy, const int n_frames)
...
template class aff3ct::module::Multiplier_AGC_cc<float>;
template class aff3ct::module::Multiplier_AGC_cc<double>;